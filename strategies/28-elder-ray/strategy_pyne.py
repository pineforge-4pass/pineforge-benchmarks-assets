...
"""
from pynecore.lib import close, color, currency, high, hline, input, low, plot, script, strategy, ta
from pynecore.types import Series


@script.strategy("Elder Ray Index", overlay=False, initial_capital=1000000, currency=currency.USD, process_orders_on_close=False, pyramiding=1, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1)
def main(
