...
"""
from pynecore.lib import close, currency, hour, input, minute, na, script, strategy, ta


@script.strategy("Parity probe 01 - stop/limit timing", shorttitle="par_p01", overlay=True, initial_capital=1000000, currency=currency.USD, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=0, process_orders_on_close=False)
def main(
