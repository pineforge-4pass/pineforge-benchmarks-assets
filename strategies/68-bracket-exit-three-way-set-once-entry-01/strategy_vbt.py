...
def run_vbt(df: pd.DataFrame, fees: float = 0.001) -> vbt.Portfolio:
    ...
    # trailTicks is 20 ticks. Assuming ETH tick size of 0.01, this represents 0.2 price units.
    trail_dist = 20 * 0.01

    @njit
    def logic_loop(open_p, high_p, low_p, close_p, hours, minutes, fees, trail_dist):
        ...
        for i in range(1, n):
            ...
            if pos == 0:
                if h_prev == 8 and m_prev == 0:
                    ...
                    stop_price = c_prev * 0.99
                    take_price = c_prev * 1.02
                    ...
                    pos = -1
                    entry_price = open_p[i]
                    stop_price = c_prev * 1.01
                    take_price = c_prev * 0.98
    ...
    entries, short_entries, exits, short_exits, exec_price = logic_loop(
        open_p, high_p, low_p, close_p, hours, minutes, fees, trail_dist
    )
