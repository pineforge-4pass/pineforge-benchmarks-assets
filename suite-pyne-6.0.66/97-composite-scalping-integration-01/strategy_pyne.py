...
"""
from pynecore.lib import close, currency, input, script, strategy, syminfo, ta


@script.strategy("PF probe scalping-probe-integration", shorttitle="PF_SCINT", overlay=True, initial_capital=1000000, currency=currency.USD, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main(
