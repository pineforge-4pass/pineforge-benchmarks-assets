...
"""
from pynecore.lib import close, currency, high, low, math, open, script, strategy, volume
from pynecore.types import Series


@script.strategy("VCP probe 05 - cumulative vol delta", shorttitle="VCP_p05", overlay=True, initial_capital=1000000, currency=currency.USD, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main():
