...
"""
from pynecore.lib import dayofweek, high, hour, low, minute, script, strategy


@script.strategy("PF probe 95 - multi-cycle open-guaranteed stops", shorttitle="PF_P95_OG", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main():
