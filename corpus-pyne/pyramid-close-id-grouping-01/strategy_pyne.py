...
@script.strategy("PF probe 60 - pyramiding close id", shorttitle="PF_P60_PYRCLOSE", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=3, process_orders_on_close=False)
def main():
