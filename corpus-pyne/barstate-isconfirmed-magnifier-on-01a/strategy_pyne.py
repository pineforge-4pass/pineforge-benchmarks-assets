...
"""
from pynecore.lib import barstate, close, script, strategy, ta
from pynecore.types import Persistent


@script.strategy("PF barstate-magnifier probe 01a - isconfirmed ON", shorttitle="BSM_01a_ON", overlay=True, initial_capital=1000000, use_bar_magnifier=True, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main():
