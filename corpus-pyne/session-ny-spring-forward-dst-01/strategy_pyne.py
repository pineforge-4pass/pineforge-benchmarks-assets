...
"""
from pynecore.lib import na, script, strategy, time, timeframe
from pynecore.types import Series


@script.strategy("PF session-dst probe 01 - NY spring forward", shorttitle="SDST_p01_NY", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main():
