...
"""
from pynecore.lib import close, high, input, low, math, script, strategy, ta
from pynecore.types import Persistent, Series


@script.strategy("PF IES probe 09 - integration", shorttitle="IES_p09_INT", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main(
