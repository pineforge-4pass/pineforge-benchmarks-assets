...
"""
from pynecore.lib import close, input, math, script, strategy, syminfo, ta


@script.strategy("PF probe 97a - tp/sl bracket isolate", shorttitle="PF_p97a_BRK", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False, calc_on_order_fills=False)
def main(
