...
"""
from pynecore.lib import hour, math, minute, script, strategy


@script.strategy("PF TV golden 44 - OCA reduce", shorttitle="PF_G44_OCA", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main():
