...
"""
from pynecore.lib import close, fixnan, na, nz, script, strategy, ta
from pynecore.types import Series


@script.strategy("PF TV golden 49 - na nz history", shorttitle="PF_G49_NA", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main():
