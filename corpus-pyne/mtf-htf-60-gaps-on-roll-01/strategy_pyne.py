...
"""
from pynecore.lib import barmerge, close, na, request, script, strategy, syminfo
from pynecore.types import Persistent


@script.strategy("PF TV golden 47 - security gaps on", shorttitle="PF_G47_GAPS", overlay=True, initial_capital=1000000, commission_type=strategy.commission.percent, commission_value=0, slippage=0, default_qty_type=strategy.fixed, default_qty_value=1, pyramiding=1, process_orders_on_close=False)
def main():
